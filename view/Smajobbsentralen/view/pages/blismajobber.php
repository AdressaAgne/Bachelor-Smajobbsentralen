...
=======
    ...
    <div class="row">
        ...
        <div class="form-element col-12">
            ...
            @foreach($class->categories() as $cat)
                <div class="col-6">
                    <input type="checkbox" name="work[]" id="{{$cat['name']}}">
                    <label class="check-label" for="{{$cat['name']}}">{{ucfirst($cat['name'])}}</label>
                </div>
            @endforeach
    ...
    <div class="row">
        ...
        <h3>Taushetserklæring:</h3>
            ...
            <label class="check-label" for="silence">Jeg godtar at opplysninger jeg får kjennskap til hos de jeg jobber for, ikke omtales til andre utenfor frivilligsentralen. Dette gjelder også etter at jeg slutter. Om avtalen brytes kan jeg ikke benyttes på oppdrag lengere.
            </label>  
        </div>
        <div class="form-element col-12">
            <input type="submit" value="Send inn søknad">
